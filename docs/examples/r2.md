...
It's easy to read and write data to and from Cloudflare R2 with obstore's [`S3Store`][obstore.store.S3Store].

Three steps:


I have a public R2 bucket I created a long time ago but rarely think about now. Looks like steps are:
